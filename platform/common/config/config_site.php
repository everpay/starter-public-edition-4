...
|--------------------------------------------------------------------------
*/
$config['copyright_note'] = 'Copyright &copy; {year} Elektropay. License: <a href="http://opensource.org/licenses/MIT" target="_blank">MIT</a>. This page has been generated in <strong>{elapsed_time} seconds</strong> using <strong>{memory_usage}</strong> of memory.';
...
|--------------------------------------------------------------------------
*/
$config['default_title'] = 'Elektropay Commerce';
